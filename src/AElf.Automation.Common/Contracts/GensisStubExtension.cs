...
namespace AElf.Automation.Common.Contracts
{
    public static class GensisStubExtension
    {
            ...
            this GenesisContract genesis)
        {
            ...
            var contract =
                new FeeReceiverContract(genesis.NodeManager, genesis.CallAddress, feeReceiver.GetFormatted());
            ...
            this GenesisContract genesis)
        {
            ...
            var contract =
                new ParliamentAuthContract(genesis.NodeManager, genesis.CallAddress, parliamentAuth.GetFormatted());

            return contract
                .GetTestStub<ParliamentAuthContractContainer.ParliamentAuthContractStub>(genesis.CallAddress);
        }
        ...
        public static ProfitContractContainer.ProfitContractStub GetProfitStub(this GenesisContract genesis)
        {
            ...
            var contract = new ProfitContract(genesis.NodeManager, genesis.CallAddress, profit.GetFormatted());
        ...
        public static TokenContractContainer.TokenContractStub GetTokenStub(this GenesisContract genesis)
        {
            ...
            var contract = new TokenContract(genesis.NodeManager, genesis.CallAddress, token.GetFormatted());
            ...
            this GenesisContract genesis)
        {
            ...
            var contract =
                new TokenConverterContract(genesis.NodeManager, genesis.CallAddress, tokenConverter.GetFormatted());

            return contract
                .GetTestStub<TokenConverterContractContainer.TokenConverterContractStub>(genesis.CallAddress);
        }
        ...
        public static TreasuryContractContainer.TreasuryContractStub GetTreasuryStub(this GenesisContract genesis)
        {
            ...
            var contract = new TreasuryContract(genesis.NodeManager, genesis.CallAddress, treasury.GetFormatted());
        ...
        public static VoteContractContainer.VoteContractStub GetVoteStub(this GenesisContract genesis)
        {
            ...
            var contract = new VoteContract(genesis.NodeManager, genesis.CallAddress, vote.GetFormatted());
        ...
        public static ElectionContractContainer.ElectionContractStub GetElectionStub(this GenesisContract genesis)
        {
            ...
            var contract = new ElectionContract(genesis.NodeManager, genesis.CallAddress, election.GetFormatted());
        ...
        public static CrossChainContractContainer.CrossChainContractStub GetCrossChainStub(this GenesisContract genesis)
        {
            ...
            var contract = new CrossChainContract(genesis.NodeManager, genesis.CallAddress, cross.GetFormatted());
            ...
            this GenesisContract genesis)
        {
            ...
            var contract =
                new AssociationAuthContract(genesis.NodeManager, genesis.CallAddress, association.GetFormatted());

            return contract.GetTestStub<AssociationAuthContractContainer.AssociationAuthContractStub>(
                genesis.CallAddress);
        }
        ...
        public static ConfigurationContainer.ConfigurationStub GetConfigurationStub(this GenesisContract genesis)
        {
            ...
            var contract =
                new ConfigurationContract(genesis.NodeManager, genesis.CallAddress, configuration.GetFormatted());
