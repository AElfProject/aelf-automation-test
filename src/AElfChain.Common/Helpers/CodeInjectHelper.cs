        ...
        public static byte[] ChangeContractCodeHash(byte[] code)
        {
            ...
            switch (condition)
            {
                case 0:
                    ...
                    break;
                case 1:
                    ilProcessorLast.InsertAfter(methodLast.Body.Instructions.Last(), ilProcessorLast.Create(OpCodes.Nop));
                    break;
                case 2:
                    ilProcessorFirst.InsertAfter(methodFirst.Body.Instructions.Last(), ilProcessorFirst.Create(OpCodes.Nop));
                    break;
                case 3:
