...
namespace AElf.Automation.Contracts.ScenarioTest
{
    ...
    public class AssociationAuthContractTest
    {
        ...
        [TestMethod]
        [DataRow("2A1RKFfxeh2n7nZpcci6t8CcgbJMGz9a7WGpC94THpiTK3U7nG","ywiz4RLJMTJaC9msxBPpaHALEZttUjMrwnhbEShrjhJ98GHAt")]
        ...
        {
            var result = Tester.AssociationService.ExecuteMethodWithResult(AssociationAuthMethod.GetProposal,Hash.LoadHex(proposalId));
            var txResult = result.InfoMsg as TransactionResultDto;
