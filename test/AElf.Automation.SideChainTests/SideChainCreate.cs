...
//
        ...
        [TestMethod]
        [DataRow("408ae6d137e6cec3928def3d1f38cbb73b8bb8c2c1ccc56265fec722501612df")]
...
//        [DataRow("921d7e83dc9f4fc2a7e643c11ca6d272684539b5cdb3ef5b1a5d7c902b7f64db")] //disposal
        ...
        public void GetProposal(string proposalId)
        {
            ...
            _logger.WriteInfo($"proposal message is {result.ProposalId},{result.ExpiredTime},{result.ToAddress},{result.OrganizationAddress},{result.ContractMethodName},{result.IsReadyToRelease}");
